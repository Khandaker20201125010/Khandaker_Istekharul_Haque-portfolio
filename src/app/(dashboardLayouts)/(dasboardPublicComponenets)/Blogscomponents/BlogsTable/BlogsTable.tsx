...
const BlogsTable = () => {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        ...
        // Use json.data which contains the array
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      Swal.fire("Deleted!", "Blog has been deleted.", "success"); // ✅ success popup
      setBlogs((prev) => prev.filter((b) => b.id !== id));
    } catch (err: any) {
      Swal.fire("Error!", err.message || "Failed to delete blog", "error"); // ❌ error popup
    }
  };
