...
const UpdateProjectModal = ({ project, onClose, onUpdated }: UpdateProjectModalProps) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 z-50 overflow-y-auto">
      <div className="bg-gray-900 p-6 rounded-xl w-full max-w-2xl border border-gray-700 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex justify-end gap-3 pt-4">
            <Button variant="gradient" onClick={onClose} type="button">Cancel</Button>
            <Button variant="gradient" type="submit">Update</Button>
          </div>
        </form>
      </div>
    </div>
